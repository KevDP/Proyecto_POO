...
void Tarjeta::set_Num_Tarjeta(string Num_Tarjeta_){         // Modificar o determinar el n�mero de tarjeta encapsulado
...
void Tarjeta::depositar(){                  // Accion depositar
    ...
    cin>>D_cantidad;
    while(D_cantidad<1){                        // Mientras la cantidad a depositar sea menor a 1, botar� el error de cantidad inv�lida.
...
void Tarjeta::retirar(){    // Acci�n retirar
    float R_cantidad;
    ...
    Fondo_tarjeta();            // De esta manera, cada que se use un retiro de efectivo, se desplegar� el Estado de cuenta actual.
}
void Tarjeta::Fondo_tarjeta(){  // Acci�n mostrar el Estado de cuenta
